...
echo_and_run cd "/home/book/ts1_ws/src/geometry-indigo-devel/tf_conversions"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/book/ts1_ws/src/geometry-indigo-devel/tf_conversions/setup.py" \
    build --build-base "/home/book/ts1_ws/build/geometry-indigo-devel/tf_conversions" \
    install \
    $DESTDIR_ARG \
